...
DATASET="alphas/barra_rev_volume_barra_rev_cost_barra_rev.parquet"

# signals=("cost_rank" "idio_vol_rank" "price_impact_rank")
# DATASET="alphas/idio_vol_rank_price_impact_rank_cost_rank.parquet"

# signals=("cost" "idio_vol" "price_impact")
# DATASET="alphas/idio_vol_price_impact_cost.parquet"
